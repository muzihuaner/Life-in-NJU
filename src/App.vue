<template>
  <v-app style="background: rgba(0,0,0,0);">
    ...
    <v-app-bar app color="rgba(0,0,0,.2)" dark flat fixed>
      <v-toolbar-title>快点搜</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-icon
        @click="open('https://github.com/muzihuaner')"
        class="mx-3"
      >
        mdi-github
      </v-icon>
      <v-icon
        class="shareLink"
        data-clipboard-text="https://new.quickso.cn"
        @click="share"
      >
        mdi-open-in-new
      </v-icon>
  ...
  methods: {
    ...
    share: function() {
      nativeShare.setShareData({
        icon: "https://cdn.jsdelivr.net/gh/muzihuaner/huancdn/img/favicon.ico",
        link: "https://new.quickso.cn",
        title: "快点搜",
        desc: "搜索，快一点！",
        from: "@HuanGeTech"
      });
